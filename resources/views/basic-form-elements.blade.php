                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="card">
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <form method="post" action="{{route('pinp')}}">
                                    @csrf    
                                        @if(Session::has('nw'))
                                        <div class="form-group">
                                            {{Session::flash('mssg', 'Your input has not passed the validation')}}
                                            <pre>
                                                <?php echo Session::get('mssg'); ?> 
                                            </pre>                     
                                            <input value="<?php echo(Session::get('nw')[0]['tbox']); ?>" type="text" name="tbox" class="form-control" /> 
                                        </div>
                                        ...
                                        @else
                                        <div class="form-group">                                
                                            <input type="text" name="tbox" class="form-control" placeholder="Name" />
                                        </div>
                                        <div class="col-lg-5 col-md-6 col-sm-10">
                                            <button type="submit" class="btn btn-primary">Primary</button>
                                        </div>
