...
<!-- Left Sidebar -->
<!--<body data-new-gr-c-s-check-loaded="8.872.0" data-gr-ext-installed="" class="theme-dark ls-toggle-menu" id=tgldrk>--><!--<aside id="leftsidebar" class="sidebar">-->
<body >
...
@section('LSidebar')
    ...
    <div class="navbar-brand">
        <button class="btn-menu ls-toggle-btn" id="navbtn" type="button"><i class="zmdi zmdi-menu"></i></button>
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li class="active open"><a href="{{route('list')}}"><i class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>
...
@section('RSidebar')
    <ul class="navbar-nav">
        ...
        <li><a href="{{route('out')}}" class="mega-menu" title="Sign Out"><i class="zmdi zmdi-power"></i></a></li>
    </ul>
</div>
...
@show
<script src="{{asset('self_created/common.js')}}"></script>

<script>
    <?php if(Cookie::get('name')==1){ ?> //If gets 1 from cookie then browser will be collapsed
        setTimeout(function(){ $("body").addClass('ls-toggle-menu'); }, 500);
    <?php } ?>

    <?php if(Cookie::get('theme')==1){ ?> //If gets 1 from cookie then browser will be collapsed
        setTimeout(function(){ $("body").addClass('theme-dark'); }, 500);
    <?php } ?>    
</script>
</body>
</html>